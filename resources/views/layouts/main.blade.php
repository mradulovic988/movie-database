    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                <li><a href="{{ route('movies.index') }}"><svg class="w-32"
                         viewBox="0 0 96 24"
                         fill="none">
                ...
                <li class="md:ml-16"><a class="hover:text-gray-300"
                       href="{{ route('movies.index') }}">Movies</a></li>
                <li class="md:ml-6"><a class="hover:text-gray-300"
                       href="#">TV Shows</a></li>
                <li class="md:ml-6"><a class="hover:text-gray-300"
                       href="#">Actors</a></li>
            </ul>
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative">
                    <input type="text"
                           class="bg-gray-800 rounded-full w-65 px-4 pl-8 py-1"
                           placeholder="Search">
