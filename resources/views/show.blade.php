...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex">
        ...
        <div class="ml-24">
            ...
            <p class="text-gray-300 mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta odio aperiam
                ipsam minus consectetur ad error eum fugit expedita, voluptatem, ex molestias reprehenderit nihil,
                deserunt quam sequi mollitia sint illum.</p>
            <div class="mt-12">
...
<div class="movie-cast border-b border-gray-800">
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            <div class="mt-8">
                <a href="#">
                    <img src="/img/actor1.jpeg"
                         alt="parasite"
                         class="hover:opacity-75 transition ease-in-out duration-150">
                </a>
                <div class="mt-2">
                    <a href="#"
                       class="text-lg mt-2 hover:text-gray:300">Real Name</a>
